...
public abstract class NetworkBoundResource<ResultType, RequestType>
{
    ...
    private void setValue(
        final Resource<ResultType> newValue )
    {
    ...
    private void fetchFromNetwork(
        final LiveData<ResultType> dbSource )
    {
        final LiveData<ApiResponse<RequestType>> apiResponse = createCall();
        // we re-attach dbSource as a new source, it will dispatch its latest value
        // quickly
    ...
    protected RequestType processResponse(
        final ApiResponse<RequestType> response )
    {
    ...
    protected abstract void saveCallResult(
        @NonNull RequestType item );

    @MainThread
    protected abstract boolean shouldFetch(
        @Nullable ResultType data );
